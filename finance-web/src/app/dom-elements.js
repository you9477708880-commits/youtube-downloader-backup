...
export function collectDom(doc = document) {
  return {
    ...
    lifeReminderQuery: $("life-reminder-query", doc),
    lifeReminderInterval: $("life-reminder-interval", doc),
    lifeReminderStatus: $("life-reminder-status", doc),
    lifeReminderSummary: $("life-reminder-summary", doc),
    lifeReminderResults: $("life-reminder-results", doc),
